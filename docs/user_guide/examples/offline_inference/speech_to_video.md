...
Source <https://github.com/vllm-project/vllm-omni/tree/main/examples/offline_inference/speech_to_video>.
...
??? abstract "speech_to_video.py"
    ``````py
    --8<-- "examples/offline_inference/speech_to_video/speech_to_video.py"
    ``````
