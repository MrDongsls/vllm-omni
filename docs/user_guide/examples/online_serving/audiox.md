...
Source <https://github.com/vllm-project/vllm-omni/tree/main/examples/online_serving/audiox>.
...
??? abstract "openai_chat_client.py"
    ``````py
    --8<-- "examples/online_serving/audiox/openai_chat_client.py"
    ``````
??? abstract "run_server.sh"
    ``````sh
    --8<-- "examples/online_serving/audiox/run_server.sh"
    ``````
