...
For standalone TTS (talker only), see the [Ming-flash-omni-TTS section in the Text-To-Speech hub](https://github.com/vllm-project/vllm-omni/tree/main/examples/online_serving/text_to_speech/README.md#ming-flash-omni-tts).
...
[`recipes/inclusionAI/Ming-flash-omni-2.0.md`](https://github.com/vllm-project/vllm-omni/tree/main/recipes/inclusionAI/Ming-flash-omni-2.0.md).
...
??? abstract "run_curl_multimodal_generation.sh"
    ``````sh
    --8<-- "examples/online_serving/ming_flash_omni/run_curl_multimodal_generation.sh"
    ``````
